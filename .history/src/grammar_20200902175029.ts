...
function selectStatement() {
    ...
    const columnList = select.right(TokenType.ColumnList);
    const Identifier = select.right(TokenType.Identifier);
    ...
    columnList.rightStatement(fromClause);
    Identifier.rightStatement(fromClause);
