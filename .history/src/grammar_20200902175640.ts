...
function selectStatement() {
    ...
    const columnList = new Statement(TokenType.ColumnList);
    const Identifier = new Statement(TokenType.Identifier);
    const Expression = new Statement(TokenType.Expression);
    ...
    // Select Grammar
    select.rightStatement(columnList).rightStatement(fromClause);
    select.rightStatement(Identifier).rightStatement(fromClause);
    select.rightStatement(Expression).rightStatement(fromClause);
