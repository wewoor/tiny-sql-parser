...
function selectStatement() {
    ...
    const fromClause = new Statement(TokenType.FromClause).right(TokenType.Identifier);

    fromClause.right(TokenType.OptionalWhereClause, true)
    .right(TokenType.Expression)
    .right(TokenType.StatementTerminator);

    fromClause.right(TokenType.OptionalLimitClause, true)
